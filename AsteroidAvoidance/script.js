...
var shdata = document.getElementById('GameTitle').innerHTML;
var highscoreText = "This text will be added to HTML";
...
gameStates[2] = function(){
    document.getElementById("butt").addEventListener("click", function(event) {
        ...
        //alert(playerName);
        const playerScore = highScore;  // replace this with the actual score value
...
//shdata = document.getElementById('GameTitle').innerHTML;
        //var newText = document.createTextNode(highscore.toString()); //creates text along with output to be displayed 
